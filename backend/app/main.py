...
async def predict_frames(segment_path: str):
    return predict_from_frames(segment_path)
...
@app.post("/predict/pipeline/frames", response_model=PipelineResponse)
async def predict_pipeline_frames_endpoint(segment_path: str):
    return predict_pipeline_from_frames(segment_path)